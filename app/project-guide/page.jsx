...
export default function ProjectGuidePage() {
  return (
    <main className={styles.page}>
      ...
      <div className={styles.content}>
        ...
        <section className={styles.section}>
          ...
          <ol>
            ...
            <li>A 50% deposit confirms the booking and starts the project.</li>
      ...
      <footer className={styles.footer}><div className={styles.footerInner}><span>© 2026 Linshi Studio</span><a href="/privacy/">Privacy</a></div></footer>
    </main>
  );
}
